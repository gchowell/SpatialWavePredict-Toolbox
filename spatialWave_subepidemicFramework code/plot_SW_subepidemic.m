...
function totinc=plot_SW_subepidemic(flag1_pass,r_pass,p_pass,a_pass,K_pass,q_pass,npatches_pass,onset_thr_pass,typedecline1_pass,I0_pass,windowsize1_pass)
...
if exist('typedecline1_pass','var')==1 & isempty(typedecline1_pass)==0
    typedecline1=typedecline1_pass;
else
    'typedecline1 value is required'
end
...
[~,x]=ode15s(@modifiedLogisticGrowthPatch,timevect,IC,[],r1,p1,a1,K1,npatches,onset_thr,q1,flag1,typedecline1);
